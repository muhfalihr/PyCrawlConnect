...
class Search:
    ...
    def search(self, keyword, page, sortby, proxy=None, cookies=None, **kwargs):
        ...
        sort = {
            "Relevance": "relevance",
            "Alphabetical (A-Z)": "alphabeticalAsc",
            "Alphabetical (Z-A)": "alphabeticalDesc"
        }
        ...
        if status_code == 200:
            ...
            div = self.parser.pyq_parser(
                html,
                '[class="_16jmeqbj4 _16jmeqbl0 _16jmeqb1s _16jmeqb18 _16jmeqb0"] [datatest-id="search-result"]'
            )
            links = []
            for a in div:
                link = (
